...
function displayGreetingMessage() {
    const greetingMessage = " Ola, eu sou seu assistente virtual. Eu te ajudo a conversar com seus arquivos em formato PDF, URL e Vídeos do Youtube. Sinta-se à vontade para fazer qualquer pergunta.";
